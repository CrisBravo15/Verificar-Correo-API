...
def obtener_argumentos():
    parser = argparse.ArgumentParser(
        description="Verifica fue comprometido usando la API de Have I Been Pwned."
    )
...
def consultar_detalle(nombre, api_key):
    """Retorna la información generada por la llamada a la API"""
